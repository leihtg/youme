...
public class AgoraMainActivity extends BaseActivity {
    ...
    public void onClickJoin(View view) {
        ...
        builder.setNegativeButton(R.string.label_audience, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                AgoraMainActivity.this.forwardToLiveRoom(Constants.CLIENT_ROLE_AUDIENCE);
            }
        });
        builder.setPositiveButton(R.string.label_broadcaster, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                AgoraMainActivity.this.forwardToLiveRoom(Constants.CLIENT_ROLE_BROADCASTER);
            }
        });
    ...
    public void forwardToLiveRoom(int cRole) {
        ...
        Intent i = new Intent(AgoraMainActivity.this, LiveRoomActivity.class);
